...
class Spider3dmgame(scrapy.Spider):
    name = "3dm"
    allowes_domains = ["www.3dmgame.com"]
    # 崩壞三 討論列表
    start_urls = ('https://www.3dmgame.com/games/yuanshen/news/')

    def __init__(self):
        executable_path = 'D:\\driver\\chromedriver96.exe'
